...
from src.database import metadata  # apenas metadata, NÃO engine

# importa os models para o Alembic enxergar as tabelas
...
# seta a URL do banco no alembic dinamicamente
